...
- **Cartão de crédito**: qualquer despesa (à vista, parcelada ou assinatura) pode ser marcada como "no cartão" e passa a contar no mês do vencimento da fatura, guardando a data da compra. Um card mostra o total da fatura do mês, quanto ela representa das despesas e marca a fatura inteira como paga; a aba Lançamentos filtra só o que foi no cartão.
